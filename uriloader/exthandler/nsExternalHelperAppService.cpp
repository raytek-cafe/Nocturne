...
static const nsDefaultMimeTypeEntry defaultMimeEntries[] = {
    ...
    {"application/x-brightwork", "bwpkg"},
    {APPLICATION_XHTML_XML, "xhtml"},
    {APPLICATION_XHTML_XML, "xht"},
    {APPLICATION_XUL_XML, "xul"},
    {TEXT_PLAIN, "txt"},
    {TEXT_CSV, "csv"},
...
static const nsExtraMimeTypeEntry extraMimeEntries[] = {
    ...
    {"application/x-brightwork", "bwpkg", "Brightwork Package"},
    ...
    {APPLICATION_XUL_XML, "xul", "XML User Interface Language"},
