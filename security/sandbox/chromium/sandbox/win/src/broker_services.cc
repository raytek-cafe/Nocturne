...
ResultCode BrokerServicesBase::SpawnTarget(
  ...
  *last_error = ERROR_SUCCESS;
  // SpawnTargetAsyncImpl may run synchronously or asynchronously depending on
  // the BrokerServicesDelegate. The CHECK below ensures SpawnTarget is only
  // used with a synchronous delegate.
