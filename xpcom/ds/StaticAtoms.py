...
STATIC_ATOMS = [
    ...
    Atom("ondialogaccept", "ondialogaccept"),
    Atom("ondialogcancel", "ondialogcancel"),
    Atom("ondialogdisclosure", "ondialogdisclosure"),
    Atom("ondialogextra1", "ondialogextra1"),
    Atom("ondialogextra2", "ondialogextra2"),
    Atom("ondialoghelp", "ondialoghelp"),
    ...
    Atom("_moz_native_controls", "-moz-native-controls"),
    ...
    Atom("PseudoStyle_MozFocusInner", ":-moz-focus-inner"),
