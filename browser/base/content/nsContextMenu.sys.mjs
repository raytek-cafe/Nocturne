...
export class nsContextMenu {
  ...
  initNavigationItems() {
    var navigationIcons = Services.prefs.getBoolPref(
    ...
    this.showItem(
      "context-reload-old",
      showItems && stopReloadItem == "reload"
    );
  ...
  initImageItems() {
    ...
    let showBGImage =
      ...
      !this.onLink &&
      !this.onTextInput;
    if (Services.prefs.getBoolPref("browser.menu.viewImage", true)) {
      this.showItem(
        "context-viewimage",
        showViewImage && !isImageOnlyProtocol
      );
      this.showItem(
        "context-viewbgimage",
        showBGImage && !isImageOnlyProtocol
      );
      this.showItem(
        "context-sep-viewbgimage",
        showBGImage && !isImageOnlyProtocol
      );
      this.document.getElementById("context-viewbgimage").disabled =
        !this.hasBGImage;
  ...
  initViewItems() {
    ...
    if (Services.prefs.getBoolPref("browser.menu.viewImage")) {
      this.showItem(
        "context-viewvideo",
