...
/**
 * Skyfox: Convert URLBar from new popover implementation to old hbox implementation
 * This provides support for reverting Bug 1921811 (https://github.com/mozilla/gecko-dev/commit/22d599d1607cf798100f87e1b25e3e4f7e247f87( when skyfox.ui.oldurlbar is enabled
 */
var SkyfoxURLBarConverter = {
  /**
  ...
  convertToOldURLBar(window) {
    ...
    newUrlbar.setAttribute("data-skyfox-old-urlbar", "true");
    document.documentElement.setAttribute("data-skyfox-old-urlbar", "true");
  },
};