...
Win11PinToTaskBarResult PinCurrentAppToTaskbarWin11(
  ...
  funcAppUserModelID =
      (SetCurrentProcessExplicitAppUserModelIDPtr)GetProcAddress(
          hDLL, "SetCurrentProcessExplicitAppUserModelID");
  ...
  NS_DispatchToMainThread(NS_NewRunnableFunction(
      ...
      [&event, &hr, &resultStatus, aCheckOnly, aFireAndForget, funcAppUserModelID,
